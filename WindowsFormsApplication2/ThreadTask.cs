...
namespace CPUTest
{
    public struct ThreadNote//线程记录表
    {
    ...
    internal class ThreadTask  //无传参线程池
    {
        private static int ThreadLength;//最大并行线程数
        private static ThreadNote[] ThreadTable;//线程状态表
        ...
        public ThreadTask(int len)
        {
            ...
            ThreadTable = new ThreadNote[ThreadLength];
    ...
    internal class intStack//线程标记栈，用于记录线程的状态和数量
    {
